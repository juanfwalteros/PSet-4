...
A continuacion se presentara un breve informe de viviendas a la venta en Bogota.
...
db_house <- import("house/Output.rds")
...
```
En el segundo grafico, en este caso de barras, se ilustra el precio promedio por cada tipo de propiedad. En este caso, los lotes son los de menor valor y los depositos los de mayor valor.